...
<head>
    ...
    <script>
        var firebaseConfig = { 
        apiKey: "AIzaSyDHryKi_c8v4ZLZkKbEa6TRboQobCcP1G8",
        authDomain: "login-minicar.firebaseapp.com",
        projectId: "login-minicar",
        storageBucket: "login-minicar.appspot.com",
        messagingSenderId: "963440550446",
        appId: "1:963440550446:web:f444189af96fdeaf52f5bf"
        };
    ...
    <script>
        google.script.run.withSuccessHandler(function(url) {
            ...
            if (user) {
               window.open('https://script.google.com/macros/s/AKfycbwB6Mqlewqf6Wt_3QkdoNz7lhkwjs6bBRkAXhsEp2W7LQcE_YM/exec');
